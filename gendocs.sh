...
#```
#mkdir ../docs #Which is in a pan_ib_topology_proj parent directory, along with the pan_ib__topology repo directory.
#cd ../docs
#git init
#git remote add origin git@github.com:nesi/pan_ib_topology.git
#git fetch origin
#git checkout --orphan gh-pages
#```
#Now we have a documentation branch we can created documentation in, and check into git.
#Git will make this available at http://nesi.github.io/pan_ib_topology/
#
